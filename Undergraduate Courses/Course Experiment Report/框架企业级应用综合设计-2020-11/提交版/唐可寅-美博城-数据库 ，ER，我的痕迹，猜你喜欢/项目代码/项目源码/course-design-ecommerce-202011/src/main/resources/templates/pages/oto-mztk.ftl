...
<head>
    ...
    <link href="/css/oto-about.css" rel="stylesheet" type="text/css"/>
...
<div class="index-top-box">
    <div class="index-top center">
        <!--收藏夹-->
        <div class="checkCity favorit css3bg fr" onMouseover="jsoverD();" onMouseout="jsoutD();">&nbsp;&nbsp;<a
...
<!--位置-->
<div class="user_here center">所在的位置：首页 > 关于我们</div>

<!--关于欧途欧-->
<div class="oto-about center">
    <div class="oto-about-left fl">
        <ul>
            <li><a href="oto-about.ftl"><span class="fr">&gt;</span>关于我们</a></li>
            <li><a href="oto-mztk.ftl"><span class="fr">&gt;</span>免责条款</a></li>
            <li><a href="oto-yqlj.ftl"><span class="fr">&gt;</span>友情链接</a></li>
            <li><a href="oto-lxwm.ftl"><span class="fr">&gt;</span>联系我们</a></li>
            <li><a href="oto-zlxz.html"><span class="fr">&gt;</span>资料下载</a></li>
            <li><a href="oto-yhzx.html"><span class="fr">&gt;</span>新闻资讯</a></li>
            <li><a href="oto-zxns.html"><span class="fr">&gt;</span>招贤纳士</a></li>
        </ul>
    </div>
    <div class="oto-about-right fr">
