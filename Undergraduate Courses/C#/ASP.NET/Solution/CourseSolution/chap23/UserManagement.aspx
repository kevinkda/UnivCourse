...
<body>
    ...
    <div style="font-size: 9pt; text-align: center;">
        <table style="font-size: 9pt; width: 501px; height: 54px; border-right: #0066cc 1px double;border-left: #0066cc 1px double; text-align: center; border-top: 1px double; border-bottom: 1px double;" cellpadding="0" cellspacing="0"  align="center">
            <tr>
                <td>
                    <asp:LinkButton ID="lnkbtnExit" runat="server" OnClick="lnkbtnExit_Click" ForeColor="black">退出</asp:LinkButton></td>
            </tr>
            <tr>
                       ...
                       <ItemTemplate>
                            <table style="width: 470px; font-size: 9pt;">
                                <tr>
                                    ...
                                    <td style="width: 81px">
                                        <asp:CheckBox ID="chkRole" 
                                            Checked ='<%# DataBinder.Eval(Container.DataItem,"Role") %>' runat="server" 
                                            Enabled="False" /></td>
                                    <td style="width: 90px">
