package com.kevinkda.univ.course.enter.framework.b20200629.web.servlet;

import com.kevinkda.univ.course.enter.framework.b20200624.constant.ConfigConsts;
import com.kevinkda.univ.course.enter.framework.b20200629.common.Utils;
import com.kevinkda.univ.course.enter.framework.b20200629.mapper.AuthorMapper;
import com.kevinkda.univ.course.enter.framework.b20200629.service.AuthorService;
 ...
 * @since 1.0.0
 */
@WebServlet(name = "AuthorServlet0629", urlPatterns = "/AuthorServlet0629")
public class AuthorServlet0629 extends HttpServlet {
    @Override
...
//        获得请求体数据
        ...
        switch ((String) reqBody.get(ConfigConsts.OPERATE_TYPE)) {
            case ConfigConsts.QUERY_ALL_FROM_AUTHOR:
                request.getSession().setAttribute("authorList", authorService.selectAuthorList(Utils.getPageBean(
                        request,
                        authorService.selectCount(),
                        reqBody
                        )
                ));
                request.getSession().setAttribute("reqBody", reqBody);
                response.sendRedirect("case/b0629/queryAll.jsp");
                break;
