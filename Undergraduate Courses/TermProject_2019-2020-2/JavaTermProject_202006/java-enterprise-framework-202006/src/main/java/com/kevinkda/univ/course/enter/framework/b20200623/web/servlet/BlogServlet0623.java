package com.kevinkda.univ.course.enter.framework.b20200623.web.servlet;

import com.kevinkda.univ.course.enter.framework.b20200623.constant.ConfigConsts;
import com.kevinkda.univ.course.enter.framework.b20200623.domain.Blog;
import com.kevinkda.univ.course.enter.framework.b20200623.service.BlogService;
 ...
 * @package com.kevinkda.univ.course.enter.framework.b20200623.web.servlet
 * @classname BlogServlet0623
 * @apiNote <p></p>
 * @since 1.0.0
 */
@WebServlet(name = "BlogServlet0623", urlPatterns = "/BlogServlet0623")
public class BlogServlet0623 extends HttpServlet {
    @Override
...
//                request.getRequestDispatcher("case/queryAll.jsp").forward(request, response);
                response.sendRedirect("case/b0623/queryAll.jsp");
                break;
            case ConfigConsts.QUERY_ITEM_FROM_BLOG:
                ...
                response.sendRedirect("case/b0623/queryItem.jsp");
                break;
            ...
            case ConfigConsts.UPDATE_ITEM_BEFORE_FROM_BLOG:
                ...
                response.sendRedirect("case/b0623/update.jsp");
                break;
