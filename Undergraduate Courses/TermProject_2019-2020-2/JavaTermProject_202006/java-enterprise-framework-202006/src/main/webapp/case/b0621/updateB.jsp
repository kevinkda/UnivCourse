...
<body>
<div class="container">
    <%--    <form action="${pageContext.request.contextPath}/BlogServlet0621?operType=updateA" method="get">--%>
    <form action="${pageContext.request.contextPath}/BlogServlet0621" method="post">
