...
<%@ page import="com.kevinkda.univ.curriculum.design.b202007.java.web.chatroom.constant.ConstConfig" %>
<%
    request.setAttribute(ConstConfig.FIELD_REQUEST_MESSAGE,
            request.getSession().getAttribute(ConstConfig.FIELD_REQUEST_MESSAGE)
    );
    request.getSession().removeAttribute(ConstConfig.FIELD_REQUEST_MESSAGE);
%>
<html>
<head>
    <title>Title</title>
...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/User/UserServlet" method="post" id="form-login"
        ...
        <p id="serviceTag">${requestScope.msg}</p>
    </form>
</div>
</body>
