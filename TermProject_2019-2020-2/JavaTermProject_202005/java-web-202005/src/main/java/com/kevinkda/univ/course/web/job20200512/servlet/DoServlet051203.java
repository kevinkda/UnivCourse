 ...
 * @since 1.0.0
 */
@WebServlet(name = "DoServlet051203", urlPatterns = "/DoServlet051203")
public class DoServlet051203 extends HttpServlet {
    @Override
...
//            对比结果一致执行成功跳转
            response.sendRedirect("case/job20200512/T3-suc.jsp");
        } else {
//            对比结果不一致执行失败跳转
            response.sendRedirect("case/job20200512/T3-login.jsp");
        }
    }
