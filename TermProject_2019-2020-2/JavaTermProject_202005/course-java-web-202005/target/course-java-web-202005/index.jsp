...
<div class="container">
    ...
    <div>
        <p>job20200515</p>
        <a href="<c:url value="case/20200515/T1.jsp"/>">job20200515/T1</a>
        <a href="<c:url value="/StudentServlet0514"/>">job20200514/T2 - StudentServlet0514</a>
    </div>
    <div>
        <p>job20200520</p>
        <a href="<c:url value="case/20200520/T1.jsp"/>">job20200520/T1</a>
        <a href="<c:url value="case/20200520/T3.jsp"/>">job20200520/T3</a>
    </div>
    <div>
        <p>job20200525</p>
        <a href="<c:url value="case/20200525/T2.jsp"/>">job20200525/T2</a>
    </div>
    <div>
        <p>job20200526</p>
        <a href="<c:url value="case/20200526/login.jsp"/>">job20200526/Login</a>
        <a href="<c:url value="case/20200526/admin/"/>">job20200526/admin</a>
    </div>
</div>
</body>
</html>
