package com.kevinkda.univ.course.enter.framework.b20200621.web.servlet;

import com.kevinkda.univ.course.enter.framework.b20200621.constant.ConfigConsts;
import com.kevinkda.univ.course.enter.framework.b20200621.service.BlogService;
 ...
 * @since 1.0.0
 */
@WebServlet(name = "BlogServlet0621", urlPatterns = "/BlogServlet0621")
public class BlogServlet0621 extends HttpServlet {
    @Override
...
//                request.getRequestDispatcher("case/queryAll.jsp").forward(request, response);
                response.sendRedirect("case/b0621/queryAll.jsp");
                break;
            case ConfigConsts.QUERY_ITEM_FROM_BLOG:
                ...
                response.sendRedirect("case/b0621/queryItem.jsp");
                break;
            ...
            case ConfigConsts.UPDATE_ITEM_BEFORE_FROM_BLOG:
                ...
                response.sendRedirect("case/b0621/update.jsp");
                break;
