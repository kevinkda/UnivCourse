    ...
    <table>
        ...
        <c:forEach var="comment" items="${sessionScope.blogList}">
            <tr>
                ...
                <td><a href="${pageContext.request.contextPath}/BlogServlet0621?operType=updateB&blogId=${comment.blogId}">update</a>
                </td>
                <td>
                ...
                <td><a href="${pageContext.request.contextPath}/BlogServlet0621?operType=delete&blogId=${comment.blogId}">delete</a>
                </td>
            </tr>
        </c:forEach>
    </table>
