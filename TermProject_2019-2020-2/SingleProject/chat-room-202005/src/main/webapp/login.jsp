...
<div class="container">
    <h2>登录</h2>
    <form action="${pageContext.request.contextPath}/UserServlet" method="post" id="form-login"
...
<script type="text/javascript">
    let result = false;//不允许注册登录
    function checkNickName() {
        let nickName = $("#nickName").val().trim();//拿到值
        if (nickName == '') {
