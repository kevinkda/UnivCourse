...
/**
 * @author Kevin KDA on 2020/2/24 15:57
 * @version 1.0
...
public class UserAcc extends UserInformation {
    ...
    public UserAcc(String strUserAccount, String strUserPassword, Date dateUserRegistrationTime,
                   String strUserPhone) {
        this.strUserAccount = strUserAccount;
        this.strUserPassword = strUserPassword;
    ...
    public UserAcc(String strPersonName, String strPersonBirth, String strPersonPhone,
                   String strPersonAddress, String strUserQq, String strPersonSex,
                   String strUserAccount, String strUserPassword) {
        super(strPersonName, strPersonBirth, strPersonPhone, strPersonAddress, strUserQq, strPersonSex);
        this.strUserAccount = strUserAccount;
        this.strUserPassword = strUserPassword;
    }
    ...
    public UserAcc(String strPersonName, String strPersonBirth, String strPersonPhone,
                   String strPersonAddress, String strUserQq, String strPersonSex,
                   String strUserAccount, String strUserPassword, Date dateUserRegistrationTime,
                   String strUserPhone) {
        super(strPersonName, strPersonBirth, strPersonPhone, strPersonAddress, strUserQq, strPersonSex);
        this.strUserAccount = strUserAccount;
        this.strUserPassword = strUserPassword;
